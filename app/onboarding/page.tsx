...
const STEPS = [
  ...
  },
  {
    key: "game",
    label: "Game",
    placeholder: "e.g. Valorant, League, CS2",
        ...
        <div className="glass-strong w-full rounded-2xl p-6 sm:p-8 animate-fade-up">
          ...
          <div className="mt-6 flex items-center justify-between gap-3">
            <button
              ...
              className="rounded-full border border-border/60 px-4 py-2 text-xs font-bold uppercase tracking-wider text-muted-foreground transition hover:border-neon-magenta/40 hover:text-neon-magenta"
            >
              {step === 0 ? "Reset" : "Back"}
            </button>
            ...
            <button
              onClick={next}
              disabled={!value.trim()}
              className="btn-neon inline-flex items-center gap-2 rounded-full px-6 py-2.5 text-xs font-bold uppercase tracking-wider disabled:cursor-not-allowed disabled:opacity-50"
            >
